...
public class RogueApplet extends Applet
{
	DrawPanel drawPanel;
	int width = 50;
	int height = 50;
	...
	char floorchar = '\u00B7';
	Vector<RogueApplet.Monster> monsters = new Vector<RogueApplet.Monster>();
	Character player;
	...
	public void genMap()
	{
		...
		Vector<RogueApplet.Room> connectedRooms = new Vector<RogueApplet.Room>();
		Vector<RogueApplet.Room> rooms = new Vector<RogueApplet.Room>();
